...
export function RepositoriesContent({ repos }: { repos: Repository[] }) {
  ...
  const filteredRepos = repos.filter((repo) => {
    ...
    if (selectedTab === "disconnected")
      return matchesSearch && !repo.isConnected;
        ...
        <Dialog open={isAddRepoOpen} onOpenChange={setIsAddRepoOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Connect a GitHub repository to enable Pull-Mate features.
              </DialogDescription>
            </DialogHeader>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Switch
                          ...
                          onCheckedChange={() =>
                            handleToggleConnection(repo.id)
                          }
                        />
                      </div>
