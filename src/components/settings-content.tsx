        ...
        <TabsContent value="profile" className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      setProfile({ ...profile, githubUsername: e.target.value })
                    }
                    className="flex-1"
                  />
                  <Button
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customize your Pull-Mate experience
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="ai" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure how Pull-Mate AI assists with your Pull Requests
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="business">
                      Business - Emphasize user impact
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setAiSettings({ ...aiSettings, autoGenerate: checked })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI will suggest relevant tests for your changes
                    </p>
                  </div>
                  <Switch
                    checked={aiSettings.includeTests}
                    onCheckedChange={(checked) =>
                      setAiSettings({ ...aiSettings, includeTests: checked })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setAiSettings({ ...aiSettings, includeDocs: checked })
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setAiSettings({ ...aiSettings, reviewSensitivity: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        When AI completes a code review
                      </p>
                    </div>
                    <Switch
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will remove access to your repositories and
                          disable Pull-Mate features. You can reconnect at any
                          time.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction onClick={handleDisconnectGitHub}>
                          Disconnect
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="webhook-url"
                  placeholder="https://your-app.com/webhooks/pullmate"
                />
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Help improve Pull-Mate with usage analytics
                      </p>
                    </div>
