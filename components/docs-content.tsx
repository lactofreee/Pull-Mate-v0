          ...
          <div className="max-w-4xl space-y-8">
            {selectedItem === "introduction" && (
              <div className="space-y-6">
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-balance mb-4">Welcome to Pull-Mate</h1>
                  <p className="text-xl text-muted-foreground text-pretty">
                    Your AI-powered Pull Request assistant that streamlines code review and collaboration.
                  </p>
                </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-pretty">
                      Pull-Mate is an intelligent assistant that helps developers create better Pull Requests faster.
                      Using advanced AI, it analyzes your code changes and generates comprehensive PR descriptions,
                      suggests improvements, and automates routine review tasks.
                    </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Use the PR Editor to create AI-assisted Pull Requests
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            {selectedItem === "ai-assistant" && (
              <div className="space-y-6">
                <div>
                  <h1 className="text-3xl font-bold tracking-tight text-balance mb-4">AI Assistant</h1>
                  <p className="text-lg text-muted-foreground text-pretty">
                    Learn how Pull-Mate's AI helps you create better Pull Requests.
                  </p>
                </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-pretty">
                      Pull-Mate's AI analyzes your code changes, commit messages, and repository context to generate
                      comprehensive PR descriptions that follow best practices.
                    </p>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Creates structured descriptions with summaries and details
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Customize AI behavior to match your preferences</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="grid gap-2 md:grid-cols-2">
                          <div className="rounded-lg border p-3">
                            ...
                            <p className="text-xs text-muted-foreground">Concise, essential information only</p>
                          </div>
                          <div className="rounded-lg border p-3">
                            <h5 className="font-medium text-sm">Detailed</h5>
                            <p className="text-xs text-muted-foreground">Comprehensive with examples</p>
                          </div>
                          <div className="rounded-lg border p-3">
                            <h5 className="font-medium text-sm">Technical</h5>
                            <p className="text-xs text-muted-foreground">Focus on implementation details</p>
                          </div>
                          <div className="rounded-lg border p-3">
                            <h5 className="font-medium text-sm">Business</h5>
                            <p className="text-xs text-muted-foreground">Emphasize user impact</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            {selectedItem === "first-pr" && (
              <div className="space-y-6">
                <div>
                  <h1 className="text-3xl font-bold tracking-tight text-balance mb-4">Creating Your First PR</h1>
                  <p className="text-lg text-muted-foreground text-pretty">
                    Step-by-step tutorial for creating your first AI-assisted Pull Request.
                  </p>
                </div>
                  ...
                  <TabsContent value="examples" className="space-y-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>See how Pull-Mate creates professional PR descriptions</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        {examplePRs.map((example, index) => (
                          <div key={index} className="space-y-3">
                            <div className="flex items-center justify-between">
                              <h4 className="font-semibold text-balance">{example.title}</h4>
                              <Button
                                variant="outline"
                                size="sm"
                      ...
                      <CardContent className="space-y-6">
                        <div className="space-y-4">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                              <h4 className="font-semibold">Navigate to PR Editor</h4>
                              <p className="text-sm text-muted-foreground text-pretty">
                                Click on "PR Editor" in the sidebar or use the "Create PR" button from the dashboard.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                              <h4 className="font-semibold">Select Repository and Branch</h4>
                              <p className="text-sm text-muted-foreground text-pretty">
                                Choose your repository and the source branch containing your changes.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                              <h4 className="font-semibold">Generate AI Draft</h4>
                              <p className="text-sm text-muted-foreground text-pretty">
                                Click the "AI Draft" button to let Pull-Mate analyze your changes and generate a PR
                                description.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-muted-foreground text-pretty">
                                Review the AI-generated content and make any necessary adjustments to match your
                                preferences.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-muted-foreground text-pretty">
                                Click "Submit PR" to create the Pull Request on GitHub with your AI-enhanced
                                description.
                              </p>
                            </div>
                          </div>
                  ...
                  <TabsContent value="tips" className="space-y-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Tips for getting the most out of Pull-Mate</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <h4 className="font-semibold mb-2">Writing Good Commit Messages</h4>
                          ...
                          <div>
                            <h4 className="font-semibold mb-2">Organizing Changes</h4>
                            <ul className="space-y-1 text-sm text-muted-foreground">
                              <li>• Keep PRs focused on a single feature or fix</li>
                              <li>• Group related changes together</li>
                              <li>• Avoid mixing refactoring with new features</li>
                            </ul>
                          </div>
                          <div>
                            <h4 className="font-semibold mb-2">Customizing AI Output</h4>
                            <ul className="space-y-1 text-sm text-muted-foreground">
                              <li>• Adjust AI settings to match your team's style</li>
            ...
            {selectedItem === "faq" && (
              <div className="space-y-6">
                <div>
                  <h1 className="text-3xl font-bold tracking-tight text-balance mb-4">Frequently Asked Questions</h1>
                  <p className="text-lg text-muted-foreground text-pretty">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    {
                      question: "Does Pull-Mate work with private repositories?",
                      answer:
