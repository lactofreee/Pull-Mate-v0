...
const mockDiff = [
  {
    ...
    deletions: 5,
    changes: [
      { type: "addition", line: 15, content: "+ const [isLoading, setIsLoading] = useState(false)" },
      { type: "addition", line: 16, content: "+ const [error, setError] = useState('')" },
      { type: "deletion", line: 18, content: "- const handleSubmit = (e) => {" },
      { type: "addition", line: 18, content: "+ const handleSubmit = async (e: FormEvent) => {" },
  ...
  },
  {
    ...
    deletions: 2,
    changes: [
      { type: "addition", line: 8, content: "+ export interface LoginResponse {" },
      ...
      { type: "addition", line: 25, content: "+ return response.json() as Promise<LoginResponse>" },
    ],
  },
]
...
export function PREditorContent() {
  ...
  const handleSubmitPR = () => {
    ...
    console.log("Submitting PR:", { title, description, selectedRepo, selectedBranch, targetBranch })
  }
  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-balance">PR Editor</h1>
          <p className="text-muted-foreground text-pretty">Create and manage your Pull Requests with AI assistance.</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select the repository and branches for your PR</CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={selectedBranch} onValueChange={setSelectedBranch}>
                    ...
                    <SelectContent>
                      <SelectItem value="feature/auth-system">feature/auth-system</SelectItem>
                      <SelectItem value="feature/ui-improvements">feature/ui-improvements</SelectItem>
                      <SelectItem value="bugfix/login-issue">bugfix/login-issue</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Provide title and description for your PR</CardDescription>
              </div>
              <Button
                variant="outline"
                size="sm"
              ...
              {useAISuggestion && (
                <div className="rounded-lg border border-primary/20 bg-primary/5 p-3">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    This content was generated based on your code changes. Feel free to edit as needed.
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <div className="space-y-6">
          <Card className="h-fit">
            <CardHeader>
              ...
              <CardDescription>Review the changes in your branch</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {mockDiff.map((file, index) => (
                      <div key={index} className="space-y-2 mb-6">
                        <div className="flex items-center justify-between rounded-lg bg-muted p-3">
                          <span className="font-mono text-sm font-medium">{file.file}</span>
                        ...
                        <div className="space-y-1 font-mono text-xs">
                          {file.changes.map((change, changeIndex) => (
                            ...
                            >
                              <span className="text-muted-foreground mr-4">{change.line}</span>
                              {change.content}
                            </div>
                          ))}
                        </div>
