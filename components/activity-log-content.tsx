...
const activityData = [
  {
    ...
    status: "merged",
    aiGenerated: true,
    description: "AI generated comprehensive PR description with security considerations",
    prNumber: 123,
  ...
  },
  {
    ...
    status: "warning",
    aiGenerated: true,
    description: "Detected potential SQL injection vulnerability in user input handling",
    prNumber: 122,
  ...
  },
  {
    ...
    status: "review",
    aiGenerated: true,
    description: "AI-assisted PR creation for comprehensive dark mode implementation",
    prNumber: 34,
  ...
  },
  {
    ...
    status: "info",
    aiGenerated: true,
    description: "Suggested improvements for code maintainability and readability",
    prNumber: 44,
...
export function ActivityLogContent() {
  ...
  const filteredActivities = activityData.filter((activity) => {
    ...
    const matchesRepo = selectedRepo === "all" || activity.repository === selectedRepo
    const matchesType = selectedType === "all" || activity.type === selectedType

    if (selectedTab === "ai") return matchesSearch && matchesRepo && matchesType && activity.aiGenerated
    if (selectedTab === "manual") return matchesSearch && matchesRepo && matchesType && !activity.aiGenerated

    return matchesSearch && matchesRepo && matchesType
  })

  const repositories = Array.from(new Set(activityData.map((activity) => activity.repository)))
  const activityTypes = Array.from(new Set(activityData.map((activity) => activity.type)))

  return (
    <div className="flex-1 space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-balance">Activity Log</h1>
        ...
        <TabsContent value="all" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>All Pull Request activities and AI interactions</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {filteredActivities.map((activity, index) => (
                    <div key={activity.id} className="flex items-start space-x-4 rounded-lg border p-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-balance">{activity.title}</h4>
        ...
        <TabsContent value="ai" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Activities powered by Pull-Mate AI</CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[600px] w-full pr-4">
                <div className="space-y-4">
        ...
        <TabsContent value="manual" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>User-initiated activities and reviews</CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[600px] w-full pr-4">
                <div className="space-y-4">
